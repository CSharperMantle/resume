...
- #link("https://ysyx.oscc.cc/en/")["One Student, One Chip" Program], Cohort 6, Level B. Student ID: 23060288. (#link("https://docs.qq.com/sheet/DWmR1dHJ5eUZkaUpW")[log], #link("https://github.com/CSharperMantle/ics2023")[repo]) #h(1fr) 2024 -- 2025
...
Skilled in reverse engineering, binary vulnerability analysis, and embedded systems security. Have experiences with software development and analysis on multiple architectures, including x86-64, AArch64, LA64 and RV64. \
...
- Resurrected the RV64 JIT backend with improvements on test pass rate and performance. #h(1fr) 2025/07 -- \
...
Maintained multiple Mozilla, VCS, and sysadmin packages. #h(1fr) 2025/09 --
...
Lifter for a custom stack machine (Catbert VM) bytecode for Binary Ninja. #h(1fr) 2024/11
